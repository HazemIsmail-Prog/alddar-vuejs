    ...
    >
        ...
        <table :class="kvTableClass">
                ...
                <tr>
                    <td colspan="2" class="py-1 !text-center !text-[15px] !font-bold underline">
                        عقد صيانة تكييف مركزي (غير شامل قطع الغيار بدون الكمبريسور).
                    </td>
                </tr>
                <tr>
                    <th>الطرف الأول:</th>
                ...
                <tr>
                    <td colspan="2">
                        لما كان الطرف الأول يقوم بكافة أعمال خدمات وصيانة التكييف المركزي على مدار الساعة، ولرغبة الطرف الثاني إسناد أعمال صيانة التكييف له وبياناتها كالتالي:-
                    </td>
                </tr>
        </table>
        ...
        <table :class="kvTableClass">
            ...
            <tr>
                ...
                <td>
                    <ol class="list-decimal list-outside ms-4">
                        <li class="font-bold">خدمة الصيانة الطارئة:-</li>
                    </ol>
                </td>
            </tr>
            <tr>
                <th></th>
                <td>
                    سوف يقدم الطرف الأول بموجب هذه الاتفاقية خدمة صيانة المكائن (وحدات) التكييف المذكورة في الكشف السابق عندما يطلب ذلك الطرف الثاني أو ممثله في العنوان السابق فقط على الأرقام التالية:
                </td>
            </tr>
            <tr>
                <th></th>
            ...
            <tr>
                ...
                <td>
                    <ol class="list-decimal list-outside ms-4">
                        <li value="2" class="font-bold">خدمة الصيانة الوقائية:-</li>
                    </ol>
                </td>
            </tr>
            <tr>
                <th></th>
                <td>
                    <ul class="list-disc list-outside font-normal ms-10">
            ...
            <tr>
                ...
                <td>
                    <ul class="list-disc list-outside font-normal ms-10">
                        <li>الكشف على السيور وضبط الشد.</li>
                    </ul>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <ul class="list-disc list-outside font-normal ms-10">
                        <li>فحص حسن أداء المراوح والمواتير.</li>
                    </ul>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <ul class="list-disc list-outside font-normal ms-10">
                        <li>فحص أجهزة الحماية والتأكد من عملها.</li>
                    </ul>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <ul class="list-disc list-outside font-normal ms-10">
                        <li>الغسيل الكامل ثلاث مرات سنوياً (بعد توقيع العقد وفي منتصف الموسم وفي آخر الموسم).</li>
                    </ul>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <ol class="list-decimal list-outside ms-4">
                        <li value="3" class="font-bold">قطع الغيار والمواد والإصلاحات:-</li>
                    </ol>
                </td>
            </tr>
            <tr>
                <th></th>
                <td>
                    سيقوم الطرف الأول بفحص جميع قطع الغيار وفحص الكمبريسور، كما أن هذا التعاقد لن يشمل الإجراءات التالية:-
                </td>
            </tr>
            <tr>
                <th></th>
            ...
            <tr>
                ...
                <td>
                    <ul class="list-disc list-outside ms-10 font-normal">
                        <li>تكاليف استبدال الماكينة أو الكمبريسور في حالة تلف الماكينة أو احتراق الكمبريسور لأي سبب كان، كما لا يشمل التعاقد (تنظيف الجريلات أو الدفيوزرات أو الدكتات أو العوازل، كما لا يشمل التعاقد أيضاً استبدال الكويلات أو الثرموستات أو البايبات أو الألواح الإلكترونية).</li>
                    </ul>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <ol class="list-decimal list-outside ms-4">
                        <li value="4" class="font-bold">
                            استبدال الكمبريسور وقطع الغيار وطريقة الدفع:-
                        </li>
                    </ol>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <ul class="list-disc list-outside ms-10 font-normal">
                        <li>هذه الاتفاقية لا تشمل استبدال قطع الغيار ولا تشمل الكمبريسور وملحقاته، ويقوم (الطرف الثاني) بدفع قيمة الكمبريسور إذا ما لزم الأمر أو لعدم وجود بدائل.</li>
                    </ul>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <ul class="list-disc list-outside ms-10 font-normal">
                        <li>يدفع (الطرف الثاني) قيمة الاستبدال بعد تقديم المطالبة، كما يحق لـ (الطرف الأول) المطالبة بدفع تلك القيمة مقدماً قبل المباشرة بالعمل.</li>
                    </ul>
                </td>
            </tr>
            <tr>
